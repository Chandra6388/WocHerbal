  ...
  const products = [
    {
      ...
      description: "Natural blend of elderberry, echinacea, and vitamin C to strengthen your immune system.",
      price: 49.99,
      priceDisplay: "$49.99",
      rating: 4.9,
    ...
    },
    {
      ...
      description: "Revitalize your day with our premium ginseng and adaptogen formula.",
      price: 39.99,
      priceDisplay: "$39.99",
      rating: 4.8,
    ...
    },
    {
      ...
      description: "Soothing blend of chamomile, ginger, and peppermint for digestive wellness.",
      price: 24.99,
      priceDisplay: "$24.99",
      rating: 4.7,
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-16 animate-fade-in-up">
          ...
          <p className="text-xl text-forest-600 max-w-3xl mx-auto">
            Carefully crafted formulations that blend traditional herbal wisdom with modern scientific research
          </p>
        </div>
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-2">
                  <h3 className="text-lg md:text-xl font-playfair font-bold text-forest-800">{product.name}</h3>
                ...
                <p className="text-forest-600 leading-relaxed text-sm md:text-base">{product.description}</p>
                ...
                <div className="space-y-3 pt-4">
                  <div className="flex items-center justify-between">
                    <span className="text-xl md:text-2xl font-playfair font-bold text-forest-800">{product.priceDisplay}</span>
                  </div>
