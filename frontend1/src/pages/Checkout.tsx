...
const Checkout = () => {
  ...
  const createOrderPayload = (paymentId: string | null = null) => ({
    ...
    paymentInfo: {
      ...
      method: formData.paymentMethod === 'razorpay' ? 'Razorpay' : 'Cash on Delivery',
    },
                  ...
                  <div>
                    ...
                    <div className="mt-2 space-y-2">
                      <label className="flex items-center">
                        <input type="radio" name="paymentMethod" value="razorpay" checked={formData.paymentMethod === 'razorpay'} onChange={handleInputChange} className="mr-2" />
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between"><span>Tax (18%)</span><span>₹{Math.round(totalPrice * 0.18)}</span></div>
                  <hr />
                  <div className="flex justify-between font-bold text-lg"><span>Total</span><span>₹{Math.round(totalPrice * 1.18)}</span></div>
                </div>
              </CardContent>
            </Card>
          </div>
